...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="https://ojs.aaai.org/index.php/AAAI/article/view/32722">
          Improving Integrated Gradient-based Transferable Adversarial Examples by Refining the Integration Path
        </a>
        (AAAI 2025)
      </td>
      <td align="center">
        <a href="https://github.com/RYC-98/MuMoDIG">MuMoDIG</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/RYC-98/MuMoDIG">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://openaccess.thecvf.com/content/CVPR2025/html/Ren_Improving_Adversarial_Transferability_on_Vision_Transformers_via_Forward_Propagation_Refinement_CVPR_2025_paper.html">
          Improving Adversarial Transferability on Vision Transformers via Forward Propagation Refinement
        </a>
        (CVPR 2025)
      </td>
      <td align="center">
        <a href="https://github.com/RYC-98/FPR">FPR</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/RYC-98/FPR">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://www.usenix.org/conference/usenixsecurity25/presentation/lin-chenhao">
          Revisiting Training-Inference Trigger Intensity in Backdoor Attacks
        </a>
        (USENIX Security 2025)
      </td>
      <td align="center">
        <a href="https://github.com/cv12ha0/TITIM">TITIM</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/cv12ha0/TITIM">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://arxiv.org/abs/2310.11850">
          Revisiting Transferable Adversarial Image Examples: Attack Categorization, Evaluation Guidelines, and New Insights
        </a>
        (arXiv 2025)
      </td>
      <td align="center">
        <a href="https://github.com/ZhengyuZhao/TransferAttackEval">TransferAttackEval</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/ZhengyuZhao/TransferAttackEval">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://ieeexplore.ieee.org/abstract/document/10418142">
          Collapse-Aware Triplet Decoupling for Adversarially Robust Image Retrieval
        </a>
        (ICML 2024)
      </td>
      <td align="center">
        <a href="https://github.com/Gandolfczjh/3D2Fool">3D2Fool</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/Gandolfczjh/3D2Fool">
      </td>
    </tr>

    <tr>
      <td>
        <a href="http://arxiv.org/abs/2403.17301">
          Physical 3D Adversarial Attacks against Monocular Depth Estimation in Autonomous Driving
        </a>
        (CVPR 2024)
      </td>
      <td align="center">
        <a href="https://github.com/michaeltian108/CA-TRIDE">CA-TRIDE</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/michaeltian108/CA-TRIDE">
      </td>
    </tr>
    ...
    <tr>
      ...
      <td align="center">
        <a href="https://github.com/yyl-github-1896/QAA">QAA</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/yyl-github-1896/QAA">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://ieeexplore.ieee.org/abstract/document/10531252">
          Exploiting the Adversarial Example Vulnerability of Transfer Learning of Source Code
        </a>
        (TIFS 2024)
      </td>
      <td align="center">
        <a href="https://github.com/yyl-github-1896/CodeTAE">CodeTAE</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/yyl-github-1896/CodeTAE">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://ieeexplore.ieee.org/abstract/document/10795188">
          Hard adversarial example mining for improving robust fairness
        </a>
        (TIFS 2024)
      </td>
      <td align="center">
        <a href="https://github.com/yyl-github-1896/HAM">HAM</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/yyl-github-1896/HAM">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://dl.acm.org/doi/full/10.1145/3702992">
          DREAM: Debugging and Repairing AutoML Pipelines
        </a>
        (TOSEM 2024)
      </td>
      <td align="center">
        <a href="https://github.com/shiningrain/DREAM">DREAM</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/shiningrain/DREAM">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://papers.neurips.cc/paper_files/paper/2022/file/c0f240bb986df54b38026398da1ae72a-Paper-Conference.pdf">
          Amplifying Membership Exposure via Data Poisoning
        </a>
        (NeurIPS 2022)
      </td>
      <td align="center">
        <a href="https://github.com/yfchen1994/poisoning_membership">poisoning_membership</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/yfchen1994/poisoning_membership">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://ieeexplore.ieee.org/abstract/document/9402077">
          AUTOTRAINER: An Automatic DNN Training Problem Detection and Repair SystemTechnical
        </a>
        (ICSE 2021)
      </td>
      <td align="center">
        <a href="https://github.com/shiningrain/AUTOTRAINER">AUTOTRAINER</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/shiningrain/AUTOTRAINER">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://www.usenix.org/system/files/sec19-xiao.pdf">
          Seeing is Not Believing: Camouflage Attacks on Image Scaling Algorithms
        </a>
        (USENIX Security 2019)
      </td>
      <td align="center">
        <a href="https://github.com/yfchen1994/scaling_camouflage">scaling_camouflage</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/yfchen1994/scaling_camouflage">
      </td>
    </tr>


    <!-- ========================================================= -->
    <!-- Multimedia Generation and Detection                       -->
    <!-- ========================================================= -->

    <tr>
      <td rowspan="3" align="center" valign="middle">
        <b>Multimedia Generation and Detection</b>
      </td>
      <td>
      ...
      <td align="center">
        <a href="https://github.com/Visual-Agent/DeepEyes">DeepEyes</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/Visual-Agent/DeepEyes">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://arxiv.org/abs/2505.17812">
          Seeing It or Not? Interpretable Vision-aware Latent Steering to Mitigate Object Hallucinations
        </a>
        (arXiv 2025)
      </td>
      <td align="center">
        <a href="https://github.com/Ziwei-Zheng/VaLSe">VaLSe</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/Ziwei-Zheng/VaLSe">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://proceedings.neurips.cc/paper_files/paper/2024/hash/6dddcff5b115b40c998a08fbd1cea4d7-Abstract-Conference.html">
          Breaking Semantic Artifacts for Generalized AI-generated Image Detection
        </a>
        (NeurIPS 2024)
      </td>
      <td align="center">
        <a href="https://github.com/Zig-HS/FakeImageDetection">FakeImageDetection</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/Zig-HS/FakeImageDetection">
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <a href="https://arxiv.org/abs/2412.13817">
          Nullu: Mitigating Object Hallucinations in Large Vision-Language Models via HalluSpace Projection
        </a>
        (CVPR 2025)
      </td>
      <td align="center">
        <a href="https://github.com/Ziwei-Zheng/Nullu">Nullu</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/Ziwei-Zheng/Nullu">
      </td>
    </tr>
    ...
    <tr>
      ...
      <td align="center">
        <a href="https://github.com/shiningrain/InvisibleHand">InvisibleHand</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/shiningrain/InvisibleHand">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://arxiv.org/abs/2407.02805">
          Efficient DNN-Powered Software with Fair Sparse Models
        </a>
        (ISSTA 2024)
      </td>
      <td align="center">
        <a href="https://github.com/Antimony5292/Ballot">Ballot</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/Antimony5292/Ballot">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://arxiv.org/abs/2304.04222">
          CILIATE: Towards fairer class-based incremental learning by dataset and training refinement
        </a>
        (ISSTA 2023)
      </td>
      <td align="center">
        <a href="https://github.com/Antimony5292/CILIATE">CILIATE</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/Antimony5292/CILIATE">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://www.usenix.org/system/files/sec22-chen-yufei.pdf">
          Teacher Model Fingerprinting Attacks Against Transfer Learning
        </a>
        (USENIX Security 2022)
      </td>
      <td align="center">
        <a href="https://github.com/yfchen1994/Teacher-Fingerprinting">Teacher-Fingerprinting</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/yfchen1994/Teacher-Fingerprinting">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://arxiv.org/abs/2204.02567">
          FairNeuron: improving deep neural network fairness with adversary games on selective neurons
        </a>
        (ICSE 2022)
      </td>
      <td align="center">
        <a href="https://github.com/Antimony5292/FairNeuron">FairNeuron</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/Antimony5292/FairNeuron">
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <a href="https://dl.acm.org/doi/abs/10.1145/3724393">
          JailGuard: A Universal Detection Framework for Prompt-based Attacks on LLM Systems
        </a>
        (TOSEM 2025)
      </td>
      <td align="center">
        <a href="https://github.com/shiningrain/JailGuard">JailGuard</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/shiningrain/JailGuard">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://openreview.net/forum?id=FAfxvdv1Dy">
          STAFF: Speculative Coreset Selection for Task-Specific Fine-tuning
        </a>
        (ICLR 2025)
      </td>
      <td align="center">
        <a href="https://github.com/shiningrain/STAFF">STAFF</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/shiningrain/STAFF">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://dl.acm.org/doi/10.1145/3643767">
          COSTELLO: Contrastive Testing for Embedding-based Large Language Model as a Service Embeddings
        </a>
        (FSE 2024)
      </td>
      <td align="center">
        <a href="https://github.com/lenijwp/COSTELLO">COSTELLO</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/lenijwp/COSTELLO">
      </td>
    </tr>
    ...
    <tr>
      <td rowspan="2" align="center" valign="middle">
        <b>Large Model Security</b>
      </td>
      <td>
        <a href="https://aclanthology.org/2025.findings-naacl.302">
      ...
      <td align="center">
        <a href="https://github.com/lenijwp/ECLIPSE">ECLIPSE</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/lenijwp/ECLIPSE">
      </td>
    </tr>

    <tr>
      <td>
        <a href="https://dl.acm.org/doi/abs/10.1145/3716497">
          Deep Learning Library Testing: Definition, Methods and Challenges
        </a>
        (CSUR 2025)
      </td>
      <td align="center">
        <a href="https://github.com/shiningrain/CSUR_DL_library_survey">CSUR_DL_library_survey</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/shiningrain/CSUR_DL_library_survey">
      </td>
    </tr>
    ...
    <tr>
      <td align="center" valign="middle">
        <b>Intelligent Identity Security</b>
      </td>
      <td>
        <a href="https://arxiv.org/abs/2511.07242">
          Privacy on the Fly: A Predictive Adversarial Transformation Network for Mobile Sensor Data
        </a>
        (AAAI 2026)
      </td>
      <td align="center">
        <a href="https://github.com/skysky4/PATN">PATN</a>
        <br>
        <img alt="Stars" src="https://img.shields.io/github/stars/skysky4/PATN">
      </td>
    </tr>
