...
<div style="display: flex; justify-content: center;">
  <table style="border-collapse: collapse; width: 80%; background: #f4f4f4; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); text-align: center;">
    ...
    <tr>
      ...
      <td style="padding: 10px; text-align: center;">1133</td>
    </tr>
    <tr>
...
| Adversarial Machine Learning | [Collapse-Aware Triplet  Decoupling for Adversarially Robust Image Retrieval](https://arxiv.org/abs/2312.07364) (ICML 2024) | [CA-TRIDE](https://github.com/michaeltian108/CA-TRIDE) <img alt="Stars" src="https://img.shields.io/github/stars/michaeltian108/CA-TRIDE"> |
